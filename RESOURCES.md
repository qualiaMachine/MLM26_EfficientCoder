...
- **UW–Madison hosted LLMs** — available to UW–Madison participants only (GlobalProtect VPN + a personal API key). Setup in [`starter/docs/uw_madison_endpoint.md`](https://github.com/qualiaMachine/MLM26_EfficientCoder/blob/main/starter/docs/uw_madison_endpoint.md).
