...
- `total_tokens` — input + output tokens summed across all 89 tasks, from Harbor's per-task `result.json` (extraction commands: [Computing your submission numbers](https://www.kaggle.com/competitions/efficient-coder/overview/evaluation))
