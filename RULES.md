...
- **Writeup required.** A submission without a writeup covering all sections of [`WRITEUP_TEMPLATE.md`](https://github.com/qualiaMachine/MLM26_EfficientCoder/blob/main/WRITEUP_TEMPLATE.md), posted in the Discussion tab and linked from the submission card, is ineligible. It is checked pass/fail for completeness, not graded.
