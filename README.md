...
- **Runs efficiently** — modest memory footprint, lean token consumption — without sacrificing capability. Use one of the approved models in MODELS.md — a deliberately short list (four model families, 7–35 GB reported VRAM) so the competition is about the scaffold, not model shopping.
