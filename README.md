...
|---|---|---|---|
| Qwen3.8-27B | `Qwen/Qwen3.8-27B-FP8` (~37 GB) | — none published | **Anchor.** Newest and strongest of the group; reasoning model. Self-host on a 48 GB card, or UW–Madison participants can use the hosted gateway (`qwen3.8-27b`) in [`starter/docs/uw_madison_endpoint.md`](https://github.com/qualiaMachine/MLM26_EfficientCoder/blob/main/starter/docs/uw_madison_endpoint.md). |
